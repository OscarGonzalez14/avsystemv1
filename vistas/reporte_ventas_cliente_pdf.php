...
$datos=$pacientes->get_paciente_por_cedula($_POST["cedula"]);
...
<table style="width: 100%; font-size: 10pt;">
  ...
  <div align="center" style="color:black; font-weight:bolder; font-size:20px;">CUENTAS DE PRODUCTOS A pacienteS   </div>
<table width="101%" class="change_order_items">

<tr>
  <th colspan="5" style="font-size:15pt">DATOS PERSONALES DEL paciente </th>
  </tr>
<tr>
...
<td><div align="center"><span class=""><?php echo $datos[$i]["cedula_paciente"];?></span></div></td>
<td style="text-align: center"><div align="center"><span class=""><?php echo $datos[$i]["nombre_paciente"];?></span></div></td>
<td style="text-align: center"><div align="center"><span class=""><?php echo $datos[$i]["telefono_paciente"];?></span></div></td>
<td style="text-align: right"><div align="center"><span class=""><?php echo $datos[$i]["direccion_paciente"];?></span></div></td>
<td style="text-align:center"><div align="center"><span class=""><?php echo $datos[$i]["correo_paciente"];?></span></div></td>
</tr>
    ...
    <tr>
      ...
      <?php
         ...
         if(is_array($venta)==true and count($venta)==0){
             ...
             echo "<span style='font-size:20px; color:red'>EL paciente NO TIENE PRODUCTOS ASOCIADOS EN LA FECHA INDICADA</span>";
