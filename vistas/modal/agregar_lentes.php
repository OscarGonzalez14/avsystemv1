<div class="modal fade" id="agregarLentes" role="dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title" align="center"><span class="glyphicon glyphicon-save" aria-hidden="true"></span> AGREGRAR LENTE</h4>
        </div>
    ...
    <input type="hidden" name="categoria" id="categoria" value="lentes" />
