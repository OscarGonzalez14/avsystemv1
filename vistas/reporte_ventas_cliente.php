 ...
 <div class="panel panel-default">
   ...
   <div class="row  col-sm-5 col-sm-offset-3">
        ...
        <div class="">
            ...
            <form action="reporte_ventas_paciente_pdf.php" method="post">
                  ...
                  <?php
                    ...
                    for($i=0;$i<sizeof($pacientes);$i++){
                       ...
                       ?>
                         ...
                         <option value="<?php echo $pacientes[$i]["cedula_paciente"]?>"><?php echo $pacientes[$i]["nombre_paciente"]?></option>
