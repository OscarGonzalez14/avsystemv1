...
<div class="content-wrapper">        
  ...
  <div class="row"><!--ROW 1-->
    ...
    <div class='col-sm-3'>
      <button class="btn btn-blue btn-block" style='right'><i class="fa fa-exchange" aria-hidden="true"></i> Traslado de Sucursal- Sucursal</button></h1></a>
    </div>
    <div class='col-sm-3'>
      <button class="btn btn-blue btn-block" style='right'><i class="fa fa-refresh" aria-hidden="true"></i> Traslado Interno</button></h1></a>
    </div>
    <div class='col-sm-3'></div>
  </div><!--FIN ROW 1-->
<br>
