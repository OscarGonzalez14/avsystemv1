<?php
     ...
     require_once("../config/conexion.php");
      ...
      class Compras extends Conectar{
             ...
             $sql="select d.numero_compra,d.sucursal,d.fecha_compra,d.modelo, p.marca,p.color,d.cantidad_compra as cantidad,
             u.usuario as usuario from 
              detalle_compras as d inner join usuarios as u on d.id_usuario=u.id_usuario 
              ...
              //luego despues de tener seleccionado el numero_compra digo que si el campo numero_compra està vacio entonces se le asigna un F000001 de lo contrario ira sumando
                       ...
                       if(empty($numero_compra["numero"]))
                    {
              ...
              
                      {
                        ...
                        $dig     = $num + 1;
                        $fact = str_pad($dig, 8, "0", STR_PAD_LEFT);
                        echo 'I'.$fact;
